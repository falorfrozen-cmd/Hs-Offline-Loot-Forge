...
`Hs-Offline-Loot-Forge` is developed as a submodule of the
...
- **This module's guide:** [`../docs/submodules/Hs-Offline-Loot-Forge/instructions.md`](../docs/submodules/Hs-Offline-Loot-Forge/instructions.md) —
  [view on GitHub](https://github.com/falorfrozen-cmd/hero-siege-offline-toolkit/blob/main/docs/submodules/Hs-Offline-Loot-Forge/instructions.md)
